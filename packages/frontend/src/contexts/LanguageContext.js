...
const translations = {
  tr: {
    ...
    businessOrders: {
      ...
      yes: 'Evet',
      no: 'Hayır',      noIdleOrders: 'Onay bekleyen sipariş yok.',
      noAwaitingDelivery: 'Teslimat bekleyen sipariş yok.',
      idleOrders: 'Onay Bekleyenler',
      awaitingDelivery: 'Teslimat Bekleyenler',
    ...
    businessOrders: {
      ...
      yes: 'Yes',
      no: 'No',      noIdleOrders: 'No orders awaiting approval.',
      noAwaitingDelivery: 'No orders awaiting delivery.',
      idleOrders: 'Awaiting Approval',
